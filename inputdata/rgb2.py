import numpy as np  #装像素数据和颜色表
import struct#进行字节转换
import matplotlib.pyplot as plt  #显示最终的图片
...
for img_name in os.listdir(file_dir1):
    InFileName= file_dir1 + img_name
    
    f=open(InFileName,'rb') #打开对应的文件
    '下面部分用来读取BMP位图的基础信息'
