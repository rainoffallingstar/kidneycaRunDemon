...
# 获取批次batch
train_dir = 'F:/kidneycaRunDemon-Shiraishi-Mai/inputdata'  # 训练样本的读入路径
logs_train_dir = 'F:/kidneycaRunDemon-Shiraishi-Mai/save'  # logs存储路径
logs_test_dir = 'F:/kidneycaRunDemon-Shiraishi-Mai/logtest'
...
try:
    ...
    for step in np.arange(MAX_STEP):
        ...
        if step % 10 == 0:
            print('Step %d, train loss = %.2f, train accuracy = %.2f%%, val loss = %.2f, val accuracy = %.2f%%' % (step, tra_loss, tra_acc * 100.0,vali_loss, vali_acc * 100.0))
